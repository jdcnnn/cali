...
The API and server folders are structural placeholders. Auth and onboarding are implemented; the other application modules described in cali.md are planned work.
